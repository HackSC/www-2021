			...
			<div style={{ marginBottom: 'calc(var(--gap-double) * 2)' }}>
				...
				<section className="first">
					...
					<p className="desc">
						...
						be a garden of students buzzing, connecting and exchanging rad ideas
						and will help you find great new recruits, ideas, and co-founders!
					</p>
					<p className="desc">
					...
					<Cards />
					<p className="desc">
						Our Seeds and Sprouts registration is closed, but Bee attendees are
					...
					>
						...
						<li>
							7:00 pm &mdash; 9:00 pm: Open Expo: Bees can buzz around and meet
							our seeds and sprouts!
						</li>
					</ul>
